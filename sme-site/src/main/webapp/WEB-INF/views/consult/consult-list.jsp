			...
			<div class="main-container-inner">
				...
				<div class="main-content">
					...
					<div class="page-content">
						<div class="row">
							<div class="col-xs-12">
								<h3 class="header smaller lighter blue">咨询列表</h3>
	...
	<script type="text/javascript">
		...
		jQuery(function($) {
			...
			jQuery(grid_selector).jqGrid({
				url: ctx+"/cp/consult/datagrid",
				datatype: "json",
				mtype: "POST",
				height: 300,
				colNames:['编码','咨询标题','分类', '咨询内容', '提交时间','状态'],
				colModel:[
					{name:'id',index:'id', width:60},
					{name:'title',index:'title', width:150},
					{name:'scodestr',index:'scodestr',width:90},
		...
		function fun_view(){
			...
			if (selectedIds.length==1){
            	window.location.href = "/cp/consult/view?id="+selectedIds[0];
			}else{
				layer.alert("请选择单条记录！");
				return;
			}
		...
		function fun_remove(){
			...
			if (selectedIds.length==1){
				$.ajax({  
                    type: "POST",  
                    url: "/cp/consult/delete?id="+selectedIds[0],  
                    dataType:"json",  
                    success: function(res){
                    	layer.msg('删除成功！', {
                    		...
                    		window.location.href = ctx+"/cp/consult/list";
                    	});
