	...
	<script type="text/javascript">
		...
		jQuery(function($) {
			...
			jQuery(grid_selector).jqGrid({
				url: ctx+"/cp/sorder/datagrid",
				datatype: "json",
				mtype: "POST",
				height: 400,
				colNames:['编码','服务项目','服务机构', '价格(元)', '库存数量(件)','下单时间','备注信息',''],
				colModel:[
					{name:'id',index:'id', width:60, sorttype:"int"},
					{name:'title',index:'title', width:150},
					{name:'svgtitle',index:'svgtitle',width:90},
					{name:'totalfee',index:'totalfee', width:70},
					{name:'totalnum',index:'totalnum', width:90, editable: true},
					{name:'addtimestr',index:'addtimestr', width:90, editable: true},
