	...
	<script type="text/javascript">
		...
		jQuery(function($) {
			...
			jQuery(grid_selector).jqGrid({
				url: ctx+"/cp/porder/datagrid",
				datatype: "json",
				mtype: "POST",
				height: 400,
				colNames:['编码','产品名称','企业名称', '数量(件)','金额(元)', '联系人','联系电话','下单时间','备注信息',''],
				colModel:[
					{name:'id',index:'id', width:60, sorttype:"int"},
					{name:'producttitle',index:'producttitle', width:150},
					{name:'buyertitle',index:'buyertitle',width:100},
					{name:'totalnum',index:'totalnum', width:90},
					{name:'totalfee',index:'totalfee', width:70},
					{name:'linker',index:'linker', width:90},
					{name:'linktel',index:'linktel', width:90},
					{name:'adddatestr',index:'adddatestr', width:90, editable: true},
