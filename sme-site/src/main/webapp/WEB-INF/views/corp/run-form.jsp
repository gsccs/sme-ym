...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>企业经营数据- 玉门市中小企业服务平台</title>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form">
									 <input type="hidden" id="corpid" name="corpid" value="${corp.id }"> 
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="year">经营年度</label>
										<div class="col-sm-6">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="employee"> 从业人数</label>

										<div class="col-sm-3">
											<input type="text" id="sale" name="sale" value="${user.employee }" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-3">
											<input type="text" id="linktel" name="linktel" value="${user.assets }" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-3">
											<input type="text" id="profits" name="profits" value="${user.profits }" />
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="tax"> 上缴税金</label>
										<div class="col-sm-3">
											<input type="text" id="tax" name="tax" value="${user.tax }" />
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="debt"> 负债总额</label>
										<div class="col-sm-3">
											<input type="text" id="debt" name="tax" value="${user.debt }" />
										</div>
									</div>
