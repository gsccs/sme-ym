			...
			<div class="main-container-inner">
				...
				<div class="main-content">
					...
					<div class="page-content">
						<div class="row">
							<div class="col-xs-12">
								<h3 class="header smaller lighter blue">工艺列表</h3>
	...
	<script type="text/javascript">
		...
		jQuery(function($) {
			...
			jQuery(grid_selector).jqGrid({
				url: ctx+"/cp/corptech/datagrid",
				datatype: "json",
				mtype: "POST",
				height: 400,
				colNames:['编码','工艺名称','备注信息'],
				colModel:[
		...
		function fun_edit(){
			window.location.href = "/cp/corptech/form";
		}
		
		function fun_del(){
			var selectedIds = $("#grid-table").jqGrid("getGridParam", "selarrrow");
			if (selectedIds.length==1){
				window.location.href = "/cp/corptech/delete?id="+selectedIds[0];
			}else{
				layer.alert("请选择单条记录！");
				return;
			}
