...
<script type="text/javascript">
	...
	function viewFun() {
		...
		if (checkedRows.length == 1) {
			location.href= ctx+"/cp/declare/form?topicid="+checkedRows[0].id;
...
<div class="admin_right">
    <div class="indent_title">
        <img src="${pageContext.request.contextPath}/resources/home/images/t_05.jpg" width="5" height="17" class="fl"><span>项目申报</span>
    </div>
    ...
    <div class="Info_center" id="Note">
        <div class="clear"></div>
        <div id="data">
        	<table id="list_data" class="easyui-datagrid" style="width:1000px;height:450px" data-options="singleSelect:true,collapsible:true">
			</table>
        </div>
    </div>
