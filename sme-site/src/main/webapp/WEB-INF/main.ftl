					...
					<div style="float: right; width: 418px;">
						...
						<div id="rdxwPanelId">
							<div style="background-color: #f9f9f9; padding: 10px; margin: 10px 0px; text-align: left; vertical-align: top;">
								<@sme_info_list channelid="101" titlelen="19" remarklen="45" dateformat="yyyy-MM-dd" num="1" ;info,index>
						...
						<div id="tzggPanelId" style="display: none;">
							<div style="background-color: #f9f9f9; padding: 10px; margin: 10px 0px; text-align: left; vertical-align: top;">
								<@sme_info_list channelid="102" titlelen="19" remarklen="45" dateformat="yyyy-MM-dd" num="1" ;info,index>
								<div style="font-size: 20px; color: #CC0000; font-weight: bold; line-height: 45px; height: 45px; letter-spacing: 2px;">
									<a href="${info.url}" class="a_title">${info.showtitle}</a>
								</div>
								<div style="font-size: 14px; color: #9b9b9b; line-height: 20px; height: 60px;">${info.showremark}...</div>
							...
							<div id="myFocus" class="mF_liuzg">
								...
								<ul class="pic">
									...
									<li><a href="#" target="_blank"><img
											src="http://dns1.smeym.org/201605/20160525090800302.jpg" alt="玉门市与省疏管局共话友谊共谋发展" /></a></li>
									<li><a href="#" target="_blank"><img
											src="http://www.ymsgxj.gov.cn/uploadfile/jpg/2016-6/2016617112833682.jpg" alt="我市与深圳科陆集团进行项目合作洽谈" /></a></li>
									<li><a href="#" target="_blank"><img
											src="${base}/resources/site/images/ink_120603pic3.jpg" alt="我市代表团参加第十二届深圳文博会" /></a></li>
									<li><a href="#" target="_blank"><img
											src="http://www.ymsgxj.gov.cn/uploadfile/jpg/2016-7/2016727164521705.jpg" alt="我市召开2016年上半年经济运行形势分析会" /></a></li>
								</ul>
							</div>
						</div>
					</div>
				...
				<div style="padding-bottom: 8px;">
					...
					<div style="width: 330px; float: right;">
						...
						<div id="rzcpPanelId"
							...
							<div class="rz_cp_box">
								<@sme_appealtopic_list gcode="212" num="8" ;topic,index>
