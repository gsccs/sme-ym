...
<title>服务项目_玉门市中小企业公共服务平台</title>
...
<script type="text/javascript">
        $(function () {
            ...
            $("#CategoryMain a").click(function () {
                window.location.href = "/sitem.html?scode=" + $(this).attr("rel") + "&keyword=" + $(".key_txt").val();
            });
            ...
            $(".bnt_search").click(function () {
                window.location.href = "/sitem.html?scode=${scode}&subscode=${subscode}&keyword=" + $(".key_txt").val();
            });
        });
    </script>
</head>
