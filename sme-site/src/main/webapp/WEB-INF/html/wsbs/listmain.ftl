...
<div class="main_w">
	<div class="w1000">
		<div class="acti_left">
			...
			<div class="top">活动预告</div>
			<@sme_activity_page dateformat="yyyy-MM-dd HH:mm" page="${page!1}" num="${num!10}";actlist,pager>
			<div id="dvActivityNotice">
				...
				<div class="main">
					...
					<div class="signup" onclick="onSignUp('${activity.id}')">
					</div>
				</div>
				</#list>
			</div>
		...
		<div class="acti_right">
			<a class="publish" href="http://account.smeym.org/"></a>
			<div class="box">
				<div class="title">
					<span></span>热门活动
				</div>
