   ...
   $(function(){
	...
	<div class="warp">
		...
		<div style="background-color: #FFFFFF; text-align: left; vertical-align: top;">
			...
			<!--内容 start-->
			<div
				style="padding: 0px 12px; text-align: left; vertical-align: top;">
				<!--图片新闻 start-->
				<div>
					<!--新闻 start-->
					<div style="float: right; width: 418px;">
						<div class="bg_title01">
							<a href="/channel.html?id=101"><div id="rdxwId" class="title01_1">热点新闻</div></a> 
						...
						<div id="tzggPanelId" style="display: none;">
							<div
								style="background-color: #f9f9f9; padding: 10px; margin: 10px 0px; text-align: left; vertical-align: top;">
							...
							<div
								style="text-align: left; vertical-align: top; line-height: 38px; font-size: 16px; height: 200px;">
								<ul>
							...
							<div id="myFocus" class="mF_liuzg">
								...
								<ul class="pic">
									...
									<li><a href="#" target="_blank"><img
											src="${base}/resources/site/images/ink_120603pic1.jpg" alt="玉门市与省疏管局共话友谊共谋发展" /></a></li>
									<li><a href="#" target="_blank"><img
											src="${base}/resources/site/images/ink_120603pic2.jpg" alt="“一带一路”会就新发展论坛活动" /></a></li>
									<li><a href="#" target="_blank"><img
											src="${base}/resources/site/images/ink_120603pic3.jpg" alt="我市代表团参加第十二届深圳文博会" /></a></li>
									<li><a href="#" target="_blank"><img
											src="${base}/resources/site/images/ink_120603pic4.jpg" alt="小微企业政策宣传暨活动月" /></a></li>
								</ul>
							</div>
						</div>
					</div>
				...
				<div style="padding-bottom: 8px;">
					...
					<div style="width: 480px; float: right;">
						<div class="bg_title02">
							<@sme_channel_list parid="105";channel,index>
							 <#if index==0>
					...
					<div style="float: right; width: 330px;">
						...
						<div style="padding: 10px 0px 0px 13px; text-align: left; vertical-align: top;">
							...
							<div class="xzfw">
								...
								<img src="${base}/resources/site/images/xzfw${index+1}.jpg" border="0" width="147" height="40" />
								</a>
							</div>
							</@sme_sclass_list>
							<div class="clear"></div>
					...
					<div
						...
						<div style="height: 340px; padding: 10px; text-align: left; vertical-align: top;">
								...
								<div style="float: right; width: 460px; height: 240px; border: 1px solid #eeeeee; padding: 10px;">
									...
									<div id="sclass_${sclass.id}" class="sclass_panel" style="display:none;">
											...
											<div
												...
												<ul>
													<@sme_svorg_list scode="${sclass.id}" titlelen="14" num="6"; svorg,index>
														<li class="fwxm_tb"><a href="${svorg.url}">${svorg.title}</a></li>
													</@sme_svorg_list>
												</ul>
											</div>
										</div>
										...
										<div style="float: left; width: 220px;">
											<div
												style="background-image: url(${base}/resources/site/images/shfw_fwxm.jpg); height: 35px;"></div>
											<div
												style="line-height: 34px; text-align: left; vertical-align: top; padding: 5px 0px;">
												<ul>
													<@sme_sitem_list scode="${sclass.id}" titlelen="14" num="6"; sitem,index>
													<li class="fwxm_tb"><a href="${sitem.url}">${sitem.title}</a></li>
													</@sme_sitem_list>
												</ul>
											</div>
										</div>
							...
							<div style="height: 70px;">
								<div style="width: 152px; height: 70px; float: right;">
									<a href="/corp.html"><img src="${base}/resources/site/images/zt_qyml.jpg" width="152"
										height="70" border="0" /></a>
								</div>
								<div
									style="width: 150px; height: 70px; float: left; margin-right: 7px;">
									<a href="/report.html"><img src="${base}/resources/site/images/zt_sjbs.jpg" width="150"
										height="70" border="0" /></a>
								</div>
								<div
									style="width: 150px; height: 70px; float: left; margin-right: 7px;">
								...
								<div
									style="width: 150px; height: 70px; float: left; margin-right: 7px;">
									<a href="/declare.html"><img src="${base}/resources/site/images/zt_xmsb.jpg" width="150"
										height="70" border="0" /></a>
								</div>
							</div>
							<!--数据专题 end-->
				...
				<div style="height: 110px; margin-bottom: 12px;">
					...
					<div style="float: left; width: 634px; height: 110px;">
						<a href="http://www.smeym.org/channel.html?id=105"><img src="${base}/resources/site/images/pic_zgzz.jpg" border="0" /></a>
					</div>
					<div class="clear"></div>
				</div>
				<!--banner2 end-->
				...
				<div style="padding-bottom: 8px;">
					...
					<div style="width: 630px; float: left;">
						...
						<div class="bz_data" style="text-align: left; vertical-align: top; line-height: 35px; font-size: 16px; height: 280px; margin: 5px 0px; ">
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
							    <tbody>
									...
									<tr>
										<td><a href="" target="_blank">${appealitem.topictitle}</a></td>
					...
					<div style="width: 330px; float: right;">
						<div class="bg_title02">
							<a href="#"><div id="rzzxId" class="tab_rzfw title02_3">融资咨询</div></a> 
							<a href="#"><div id="rzzcId" class="tab_rzfw title02_3">融资政策</div></a> 
							<a href="#"><div id="rzcpId" class="tab_rzfw title02_2">融资产品</div></a>
							<div class="title02_1">融资服务</div>
							<div class="clear"></div>
						</div>

						<div id="rzcpPanelId"
							style="text-align: left; vertical-align: top; line-height: 35px; font-size: 16px; height: 280px; background-color: #f9f9f9; margin: 5px 0px; padding: 10px;">
							<div class="rz_cp_box">
						...
						<div id="rzzcPanelId"
							...
							<ul>
								 <@sme_info_list channelid="101" titlelen="15" dateformat="yyyy-MM-dd" num="8";info,index>
								<li>
									<a href="${info.url}" title="${info.title}" target="_blank">・&nbsp;${info.showtitle}…</a>
								</li>
								</@sme_info_list>
						...
						<div id="rzzxPanelId"
							style="text-align: left; vertical-align: top; font-size: 14px; height: 280px; background-color: #f9f9f9; margin: 5px 0px; padding: 10px; display: none;">
							<@sme_consult_list gcode="212" num="3" remarklen="20";consult,index>
							<div style="min-height:60px; margin:0px auto; margin-top:10px; overflow:hidden;">
					            ...
					            <!--
					            <div class="qd"><div class="qdd">答</div><div class="qda">(一)该商标为本省自然人、法人和其他组织所拥有的有效注册商标，</div></div>
					            -->
					        </div>
					        </@sme_consult_list>
						</div>
