	...
	<div class="main_w">
		<div class="w1000 s_top">
			...
			<div class="s_top_title">
				...
				<div class="s_top_title_type">人才培训</div>
		...
		<div class="w1000 s_main">
			<div class="s_main_left">
				...
				<div class="sml_content">
					<div id="dvPrdt">
						<@sme_sitem_page svgid="${currSvorg.id}" page="1" num="10" pagenum="${pagenum!0}"; sitemList,pager>
						...
						<div class="smlc_prdt_img">
							<div class="img_p">
								<p class="img-box">
									<a href="#Service/ItemDetail/405"><img
										alt="产品研发" src="./机构详情_files/201403131652025363图片1.jpg"
										onerror="this.onerror=null;this.src=&#39;/resources/site/images/no.png&#39;"></a>
								</p>
							</div>
						</div>
						<ul class="smlc_prdt_info">
							<li class="smlcp_title"><a
								href="#Service/ItemDetail/405">产品研发</a></li>
							<li class="smlcp_cont"><dl>
									<dt>服务区域：</dt>
									<dd>玉门市</dd>
								</dl></li>
					...
					<div id="dvPage">
						<div class="maunlist">
							<div class="manur">共 10 条</div>
							<div class="manuleft">
								<a href="javascript:void(0)" onclick="Pagination(1)"
									class="hover">1</a><a href="javascript:void(0)"
									onclick="Pagination(2)">2</a><a href="javascript:void(0)"
									onclick="Pagination(3)">3</a><a href="javascript:void(0)"
									onclick="Pagination(2)">下一页</a><a href="javascript:void(0)"
									onclick="Pagination(3)">末页</a>
							</div>
						</div>
					</div>
				</div>
