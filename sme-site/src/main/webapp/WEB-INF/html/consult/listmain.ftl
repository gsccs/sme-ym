...
<div class="main_w">
	<div class="w1000">
		<div class="main_l fl">
			...
			<div class="list_main">
				<@sme_consult_page page="${page!1}" num="${num!10}" pagenum="${pagenum!0}" scode="${scode}" keyword="${keyword}"; consultList,pager>
				<#list consultList as consult>
				<div class="Info">
					<div style="min-height:60px; width:614px; margin:0px auto; margin-top:10px; overflow:hidden;">
			        	<div class="q1">${consult.id}.${consult.title}</div>
			            <div class="qw"><div class="qww">问</div><div class="qwt">${consult.content}</div></div>
			            <#list consult.replyList as reply>
			            <div class="qd"><div class="qdd">答</div><div class="qda">${reply.content}</div></div>
			            </#list>
			        </div>
					<div class="clear"></div>
				</div>
