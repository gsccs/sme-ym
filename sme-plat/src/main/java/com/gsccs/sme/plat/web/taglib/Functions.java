package com.gsccs.sme.plat.web.taglib;

import com.gsccs.sme.plat.auth.model.*;
import com.gsccs.sme.plat.auth.service.*;
...
public class Functions {
	...
	public static String roleName(Long roleId) {
		Role role = getRoleService().findByRoleid(roleId);
		if (role == null) {
			return "";
		}
