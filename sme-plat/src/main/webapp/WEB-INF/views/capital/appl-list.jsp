...
<body>
	...
	<script type="text/javascript">
		...
		function loadreplys(id){
			$.ajax({
				type : "POST",
				url : ctx+'/capital/applrp/dg',
				data : "page=1&rows=50&applid="+id,
				dataType : 'json',
		...
		function reply(){
			...
			if (checkedRows.length == 1)
				self.location = ctx+"/capital/reply?id="+ checkedRows[0].id;
