			...
			<table cellpadding="3" cellspacing="0" class="edit_table"
				...
				<tr>
					...
					<td><select name="barcode" id="barcode"
						onclick="a(this.value)" style="width: 190px;">
					...
					</select> <select name="tags" id="tags" style="width: 190px;">
							<option value="${sneedT.tags}">${sneedT.tags}</option>
					</select></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input style="width: 130px;" name="addtime"
						value="${sneedT.addtimeStr}" class="easyui-datebox"
