...
<%-- <script type="text/javascript"
	src="${pageContext.request.contextPath}/static/js/Product.js"></script> --%>
<script type="text/javascript"
...
<body style="margin: 10px; padding: 0px; background-color: #fff;">
	...
	<fieldset>
		<legend style="font-weight: bold; font-size: 16pt; color: #E3393C;">服务专家注册</legend>
			...
			<table cellpadding="3" cellspacing="0" class="edit_table"
				...
				<tr>
					...
					<td><input type="text" name="title" value="${expertT.title}"
						style="width: 150px;" maxlength="512" data-options="required:true,validType:'NULL'"
				...
				<tr>
					...
					<td>
					<input type="radio" checked="checked" name="sex" id="男" value="男" /> 
					<label for="男">男</label>
