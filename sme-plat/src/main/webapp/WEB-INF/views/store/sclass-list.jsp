...
<body>
 <form id="searchForm">
     <input class="easyui-searchbox" id="parids" data-options="prompt:'请输入父分类名称查询',searcher:doSearch" style="width:200px"></input>
	 </form>
    <div style="height:93%">
	<table id="list_data" cellspacing="0" cellpadding="0">
		<thead>
			<tr>
			<!-- 	<th field="id" width="100">分类编号</th> 
				<th field="parid" width="100">父分类编号</th>  -->
				<th field="title" width="200">分类名称</th>
			</tr>
		</thead>
	</table>
	</div>
