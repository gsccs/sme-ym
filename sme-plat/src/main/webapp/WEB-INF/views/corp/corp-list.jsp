...
var ctx = "${pageContext.request.contextPath}";
		...
		//新增
		function add(){
			self.location = "${pageContext.request.contextPath}/corp/form";
		}
		...
		function edit(){
			...
			if (checkedRows.length == 1)
				self.location = "${pageContext.request.contextPath}/corp/form?id="
						+ checkedRows[0].id;
		...
		function view(){
			var checkedRows = $("#list_data").datagrid('getChecked');
			if (checkedRows.length == 1)
				self.location = "${pageContext.request.contextPath}/corp/view?id="
						+ checkedRows[0].id;
			else if (checkedRows.length > 1) {
				$.messager.show({
					title : '提示',
